...
- [Instalació](#markdown-header-instalaci%C3%B3)
- [Configuració](#markdown-header-configuraci%C3%B3)
- [Via API](#markdown-header-via-api)
    - [Funcions](#markdown-header-funcions)
        - [Definició de censos i entitats](#markdown-header-definici%C3%B3-de-censos-i-entitats)
            - [censuses()](#markdown-header-censuses)
            - [census($short_name)](#markdown-header-censusshort_name)
            - [censusEntities($short_name)](#markdown-header-censusentitiesshort_name)
            - [entities()](#markdown-header-entities)
            - [entity($short_name)](#markdown-header-entityshort_name)
            - [entityFields($short_name)](#markdown-header-entityfieldsshort_name)
            - [entityField($entity_name, $field_name)](#markdown-header-entityfieldentity_name-field_name)
            - [entityGridFields($short_name, $grid_name)](#markdown-header-entitygridfieldsshort_name-grid_name)
        - [Accedint a les instàncies (Crear, modificar i consultar)](#markdown-header-accedint-a-les-inst%C3%A0ncies-crear-modificar-i-consultar)
            - [instances($census_name, $entity_name, $options=[])](#markdown-header-instancescensus_name-entity_name-options)
            - [search($census_name, $entity_name, $filters, $options=[])](#markdown-header-searchcensus_name-entity_name-filters-options)
            - [instancesTree($census_name, $entity_name, $field_name, $options=[])](#markdown-header-instancestreecensus_name-entity_name-field_name-options)
            - [instance($census_name, $entity_name, $id, $options=[])](#markdown-header-instancecensus_name-entity_name-id-options)
            - [getInstanceField($census_name, $entity_name, $id, $field_name)](#markdown-header-getinstancefieldcensus_name-entity_name-id-field_name)
            - [createInstance($census_name, $entity_name, $fields)](#markdown-header-createinstancecensus_name-entity_name-fields)
            - [deleteInstance($census_name, $entity_name, $id, $hard=false)](#markdown-header-deleteinstancecensus_name-entity_name-id-hardfalse)
            - [updateInstance($census_name, $entity_name, $id, $fields)](#markdown-header-updateinstancecensus_name-entity_name-id-fields)
            - [updateInstanceField($census_name, $entity_name, $id, $field_name, $value)](#markdown-header-updateinstancefieldcensus_name-entity_name-id-field_name-value)
            - [clearInstanceField($census_name, $entity_name, $id, $field_name)](#markdown-header-clearinstancefieldcensus_name-entity_name-id-field_name)
            - [addInstanceFieldItem($census_name, $entity_name, $id, $field_name, $value)](#markdown-header-addinstancefielditemcensus_name-entity_name-id-field_name-value)
            - [removeInstanceFieldItem($census_name, $entity_name, $id, $field_name, $item_id)](#markdown-header-removeinstancefielditemcensus_name-entity_name-id-field_name-item_id)
        - [Graelles (Grids)](#markdown-header-graelles-grids)
            - [getInstanceGridItems($census_name, $entity_name, $id, $grid_name)](#markdown-header-getinstancegriditemscensus_name-entity_name-id-grid_name)
            - [getInstanceGridItem($census_name, $entity_name, $id, $grid_name, $grid_item_id)](#markdown-header-getinstancegriditemcensus_name-entity_name-id-grid_name-grid_item_id)
            - [addInstanceGridItem($census_name, $entity_name, $id, $grid_name, $values=[])](#markdown-header-addinstancegriditemcensus_name-entity_name-id-grid_name-values)
            - [updateInstanceGridItem($census_name, $entity_name, $id, $grid_name, $grid_item_id, $values=[])](#markdown-header-updateinstancegriditemcensus_name-entity_name-id-grid_name-grid_item_id-values)
            - [removeInstanceGridItem($census_name, $entity_name, $id, $grid_name, $grid_item_id)](#markdown-header-removeinstancegriditemcensus_name-entity_name-id-grid_name-grid_item_id)
        - [Entitats relacionades](#markdown-header-entitats-relacionades)
            - [addInstanceRelatedItem($census_name, $entity_name, $id, $field_name, $item_id)](#markdown-header-addinstancerelateditemcensus_name-entity_name-id-field_name-item_id)
            - [removeInstanceRelatedItem($census_name, $entity_name, $id, $field_name, $item_id)](#markdown-header-removeinstancerelateditemcensus_name-entity_name-id-field_name-item_id)
        - [Attachments (documents)](#markdown-header-attachments-documents)
            - [getAttachment($attachment_id)](#markdown-header-getattachmentattachment_id)
            - [getAttachmentContent($attachment_id)](#markdown-header-getattachmentcontentattachment_id)
            - [downloadAttachment($attachment_id)](#markdown-header-downloadattachmentattachment_id)
        - [Trees Feature](#markdown-header-trees-feature)
            - [getTrees($options=[])](#markdown-header-gettreesoptions)
            - [getTree($tree_id, $options=[])](#markdown-header-gettreetree_id-options)
            - [getTreeNodes($tree_id, $options=[])](#markdown-header-gettreenodestree_id-options)
            - [getNode($tree_id, $node_id, $options=[])](#markdown-header-getnodetree_id-node_id-options)
            - [getNodeChildren($tree_id, $node_id, $options=[])](#markdown-header-getnodechildrentree_id-node_id-options)
            - [getNodeParent($tree_id, $node_id, $options=[])](#markdown-header-getnodeparenttree_id-node_id-options)
            - [getNodeAncestors($tree_id, $node_id, $options=[])](#markdown-header-getnodeancestorstree_id-node_id-options)
            - [getNodeDescendants($tree_id, $node_id, $options=[])](#markdown-header-getnodedescendantstree_id-node_id-options)
            - [getNodeSiblings($tree_id, $node_id, $direction=null, $options=[])](#markdown-header-getnodesiblingstree_id-node_id-directionnull-options)
    - [Classes](#markdown-header-classes)
        - [Census](#markdown-header-census)
            - [entity($entity_name)](#markdown-header-entityentity_name)
            - [entities()](#markdown-header-entities_1)
        - [Entity](#markdown-header-entity)
            - [fields()](#markdown-header-fields)
            - [field($short_name)](#markdown-header-fieldshort_name)
            - [relatedEntity($short_name)](#markdown-header-relatedentityshort_name)
            - [forCensus($census_name)](#markdown-header-forcensuscensus_name)
            - [all($options=[])](#markdown-header-alloptions)
            - [get($id, $options=[])](#markdown-header-getid-options)
            - [search($filters, $options=[])](#markdown-header-searchfilters-options)
            - [tree( $short_name, $options=[])](#markdown-header-tree-short_name-options)
            - [create( $options=[])](#markdown-header-create-options)
        - [Field](#markdown-header-field)
            - [settings()](#markdown-header-settings)
            - [options()](#markdown-header-options)
            - [gridFields()](#markdown-header-gridfields)
            - [relatedEntity()](#markdown-header-relatedentity)
        - [Instance](#markdown-header-instance)
            - [entity()](#markdown-header-entity)
            - [census()](#markdown-header-census)
            - [update($fields)](#markdown-header-updatefields)
            - [get($field_name)](#markdown-header-getfield_name)
            - [set($field_name, $value)](#markdown-header-setfield_name-value)
            - [add($field_name, $value)](#markdown-header-addfield_name-value)
            - [clear($field_name)](#markdown-header-clearfield_name)
            - [remove($field_name, $item_id)](#markdown-header-removefield_name-item_id)
            - [delete()](#markdown-header-delete)
            - [destroy()](#markdown-header-destroy)
        - [TreeNode](#markdown-header-treenode)
            - [parent($options=[])](#markdown-header-parentoptions)
            - [siblings($direction=null, $options=[])](#markdown-header-siblingsdirectionnull-options)
            - [descendants($options=[])](#markdown-header-descendantsoptions)
            - [ancestors($options=[])](#markdown-header-ancestorsoptions)
            - [children($options=[])](#markdown-header-childrenoptions)
- [Vía Base de Dades (Eloquent )](#markdown-header-v%C3%ADa-base-de-dades-eloquent-)
    - [Camps data](#markdown-header-camps-data)
    - [Integracions i Mapes](#markdown-header-integracions-i-mapes)
    - [Relacions](#markdown-header-relacions)
    - [Selects](#markdown-header-selects)
